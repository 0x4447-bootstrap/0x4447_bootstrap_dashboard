export const env = {
  ...
  STRIPE_PRICE_MONTH_PRICE: process.env.STRIPE_PRICE_MONTH_PRICE,
  STRIPE_PRICE_ID_YEAR: process.env.STRIPE_PRICE_ID_YEAR,
  STRIPE_PRICE_YEAR_PRICE: process.env.STRIPE_PRICE_YEAR_PRICE,
  STRIPE_PUBLIC_KEY: process.env.STRIPE_PUBLIC_KEY,
  VERSION_DASHBOARD_DEBUG_VERSION: process.env.VERSION_DASHBOARD_DEBUG_VERSION
}
